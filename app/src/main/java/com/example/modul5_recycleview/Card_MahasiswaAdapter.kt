...
class Card_MahasiswaAdapter(private val context: Context, private val dataList: List<Inis_Variable>, val listener: (Inis_Variable) ->
Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() { override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
    ...
    inner class MyViewHolder(itemView: View) :
        ...
        fun bindView(mhs: Inis_Variable, listener: (Inis_Variable) -> Unit) { cardView.setOnClickListener { listener(mhs)
